...
public class IpnService {
    ...
    public IpnService(AccountService accountService, TenantRepository tenantRepository,
                      ProcessAlert processAlert, AXWorker axWorker, IpnLogService ipnLogService) {
...
//    private String externalUrl = "https://evolve.ryleq.com/fineract-provider/api/v1/";
    ...
    public TenantIdEntity validateIdNo(MpesaRequest mpesaRequest) {
        ...
        try {
            ...
            if (!isBlank(tenantDto.getId())) {
                ...
                System.out.println("url::=>" + axWorker.externalUrl + urlEndpoint);
